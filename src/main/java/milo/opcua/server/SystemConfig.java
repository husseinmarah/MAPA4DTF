...
public class SystemConfig {
    ...
    public static final RobotConfig[] ROBOTS = {
        ...
        new RobotConfig("enabled", "enabled", Identifiers.Boolean, false),  // Start disabled, OPA will enable if authorized
    };
    ...
    public static final ComponentProperty[] COMPONENT_PROPERTIES = {
        new ComponentProperty("pathwayProperties", "pathwayProperties-unique-identifier", "configs/pathwayProperties.json"),
        new ComponentProperty("idleProperties", "idleProperties-unique-identifier", "configs/idleProperties.json"),
        new ComponentProperty("outputconveyorProperties", "outputconveyorProperties-unique-identifier", "configs/outputconveyorProperties.json"),
        new ComponentProperty("inputconveyorProperties", "inputconveyorProperties-unique-identifier", "configs/inputconveyorProperties.json")
    };
